#!/usr/bin/env python3
"""
TEMS API Gateway Test Script - Trial 3 HENNEO
==============================================

This script demonstrates the complete flow for using the TEMS API Gateway with the HENNEO API.

Real API endpoint to be tested trough API GATEWAY: https://tems-henneo-tmt7x6vxma-ey.a.run.app/healthcheck
...
# Initial banner
print_header("TEMS API Gateway Test - Trial 3 HENNEO")
print("This script will test the TEMS API Gateway with the HENNEO API endpoint.\n")
...
# ============================================================================
# STEP 4: Test API call through API Gateway (HENNEO /healthcheck endpoint)
# ============================================================================
print_step(4, "API Test Call through API Gateway - HENNEO Healthcheck")
print()

original_endpoint = "https://tems-henneo-tmt7x6vxma-ey.a.run.app/healthcheck"
gateway_api_endpoint = f"{api_gateway_endpoint}/apigateway/healthcheck"
...
print_info("The API Gateway will forward the request to the HENNEO API endpoint")
...
try:
    print_info("Sending GET request to /healthcheck...")
...
print()
print(f"{Colors.CYAN}3. HENNEO API CALL THROUGH GATEWAY{Colors.ENDC}")
print(f"   ✓ Successfully called HENNEO API through TEMS API Gateway")
print(f"   ✓ Tested endpoint: /healthcheck")
print()
print(f"{Colors.GREEN}{Colors.BOLD}Success!{Colors.ENDC} {Colors.GREEN}TEMS API Gateway is working correctly with Trial 3 HENNEO!{Colors.ENDC}")
print()
