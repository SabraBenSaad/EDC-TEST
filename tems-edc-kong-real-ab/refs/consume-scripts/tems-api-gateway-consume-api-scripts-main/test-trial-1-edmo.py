#!/usr/bin/env python3
"""
TEMS API Gateway Test Script - Trial 1 EDMO
============================================

This script demonstrates the complete flow for using the TEMS API Gateway with the EDMO API.

Real API endpoint to be tested trough API GATEWAY: https://truly-lab.herokuapp.com/collections/latest/items?type=string
...
# Initial banner
print_header("TEMS API Gateway Test - Trial 1 EDMO")
print("This script will test the TEMS API Gateway with the EDMO API endpoint.\n")
...
# ============================================================================
# STEP 4: Test API call through API Gateway (EDMO endpoint)
# ============================================================================
print_step(4, "API Test Call through API Gateway - EDMO Endpoint")
print()

original_endpoint = "https://truly-lab.herokuapp.com/collections/latest/items?type=string"
gateway_api_endpoint = f"{api_gateway_endpoint}/apigateway/collections/latest/items?type=string"
...
print_info("The API Gateway will forward the request to the EDMO API endpoint")
...
print()
print(f"{Colors.CYAN}3. EDMO API CALL THROUGH GATEWAY{Colors.ENDC}")
print(f"   ✓ Successfully called EDMO API through TEMS API Gateway")
print(f"   ✓ Tested endpoint: /collections/latest/items?type=string")
print()
print(f"{Colors.GREEN}{Colors.BOLD}Success!{Colors.ENDC} {Colors.GREEN}TEMS API Gateway is working correctly with Trial 1 EDMO!{Colors.ENDC}")
print()
