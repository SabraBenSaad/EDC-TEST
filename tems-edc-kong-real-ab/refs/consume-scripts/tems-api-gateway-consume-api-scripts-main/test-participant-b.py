#!/usr/bin/env python3
"""
TEMS API Gateway Test Script - Trial PARTICIPANT_B
============================================

This script demonstrates the complete flow for using the TEMS API Gateway with the PARTICIPANT_B API.

Real API endpoint to be tested trough API GATEWAY: https://participant-b.tems-dataspace.eu/v2/store/inventory
...
# Initial banner
print_header("TEMS API Gateway Test - Trial PARTICIPANT_B")
print("This script will test the TEMS API Gateway with the PARTICIPANT_B API endpoint.\n")
...
# ============================================================================
# STEP 4: Test API call through API Gateway (PARTICIPANT_B /v2/store/inventory endpoint)
# ============================================================================
print_step(4, "API Test Call through API Gateway - PARTICIPANT_B /v2/store/inventory Endpoint")
print()

original_endpoint = "https://participant-b.tems-dataspace.eu/v2/store/inventory"
gateway_api_endpoint = f"{api_gateway_endpoint}/apigateway/v2/store/inventory"
...
print_info("The API Gateway will forward the request to the PARTICIPANT_B API endpoint")
...
try:
    print_info("Sending GET request /v2/store/inventory...")
...
print()
print(f"{Colors.CYAN}3. PARTICIPANT_B API CALL THROUGH GATEWAY{Colors.ENDC}")
print(f"   ✓ Successfully called PARTICIPANT_B API through TEMS API Gateway")
print(f"   ✓ Tested endpoint: /v2/store/inventory")
print()
print(f"{Colors.GREEN}{Colors.BOLD}Success!{Colors.ENDC} {Colors.GREEN}TEMS API Gateway is working correctly with Trial PARTICIPANT_B!{Colors.ENDC}")
print()
