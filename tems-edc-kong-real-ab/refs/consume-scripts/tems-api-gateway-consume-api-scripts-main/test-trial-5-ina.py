#!/usr/bin/env python3
"""
TEMS API Gateway Test Script - Trial 5 INA
==============================================

This script demonstrates the complete flow for using the TEMS API Gateway with the INA API.

Real API endpoint to be tested trough API GATEWAY: https://ina.demo.isan.org/api/v0/info
...
# Initial banner
print_header("TEMS API Gateway Test - Trial 5 INA")
print("This script will test the TEMS API Gateway with the INA API.\n")
...
# ============================================================================
# STEP 4: Test API call through API Gateway (INA /info endpoint)
# ============================================================================
print_step(4, "API Test Call through API Gateway - INA Info")
print()
...
print_info("The API Gateway will forward the request to the INA API endpoint")
...
print()
print(f"{Colors.CYAN}3. INA API CALL THROUGH GATEWAY{Colors.ENDC}")
print(f"   ✓ Successfully called INA API through TEMS API Gateway")
