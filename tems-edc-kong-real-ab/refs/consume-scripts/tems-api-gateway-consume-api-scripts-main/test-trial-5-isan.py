#!/usr/bin/env python3
"""
TEMS API Gateway Test Script - Trial 5 ISAN
==============================================

This script demonstrates the complete flow for using the TEMS API Gateway with the ISAN API.

Real API endpoint to be tested trough API GATEWAY: https://sandbox.isan.org/api/v3/edc-poc/info
...
# Initial banner
print_header("TEMS API Gateway Test - Trial 5 ISAN")
print("This script will test the TEMS API Gateway with the ISAN API.\n")
...
# ============================================================================
# STEP 4: Test API call through API Gateway (ISAN /info endpoint)
# ============================================================================
print_step(4, "API Test Call through API Gateway - ISAN Info")
print()

original_endpoint = "https://ina.demo.isan.org/api/v0/info"
gateway_api_endpoint = f"{api_gateway_endpoint}/apigateway/info"
...
print_info("The API Gateway will forward the request to the ISAN API endpoint")
...
try:
    print_info("Sending GET request to /info...")
...
print()
print(f"{Colors.CYAN}3. ISAN API CALL THROUGH GATEWAY{Colors.ENDC}")
print(f"   ✓ Successfully called ISAN API through TEMS API Gateway")
print(f"   ✓ Tested endpoint: /info")
print()
print(f"{Colors.GREEN}{Colors.BOLD}Success!{Colors.ENDC} {Colors.GREEN}TEMS API Gateway is working correctly with Trial 5 ISAN!{Colors.ENDC}")
print()