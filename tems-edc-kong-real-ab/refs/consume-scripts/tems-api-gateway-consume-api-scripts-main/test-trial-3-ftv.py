#!/usr/bin/env python3
"""
TEMS API Gateway Test Script - Trial 3 FTV
===========================================

This script demonstrates the complete flow for using the TEMS API Gateway with the FTV API.

Real API endpoint to be tested trough API GATEWAY: https://tems-francetv-tmt7x6vxma-ey.a.run.app/healthcheck
...
# Initial banner
print_header("TEMS API Gateway Test - Trial 3 FTV")
print("This script will test the TEMS API Gateway with the FTV API endpoint.\n")
...
# ============================================================================
# STEP 4: Test API call through API Gateway (FTV /healthcheck endpoint)
# ============================================================================
print_step(4, "API Test Call through API Gateway - FTV Healthcheck")
print()

original_endpoint = "https://tems-francetv-tmt7x6vxma-ey.a.run.app/healthcheck"
...
print_info("The API Gateway will forward the request to the FTV API endpoint")
...
print()
print(f"{Colors.CYAN}3. FTV API CALL THROUGH GATEWAY{Colors.ENDC}")
print(f"   ✓ Successfully called FTV API through TEMS API Gateway")
print(f"   ✓ Tested endpoint: /healthcheck")
print()
print(f"{Colors.GREEN}{Colors.BOLD}Success!{Colors.ENDC} {Colors.GREEN}TEMS API Gateway is working correctly with Trial 3 FTV!{Colors.ENDC}")
print()
