#!/usr/bin/env python3
"""
TEMS API Gateway Test Script - Trial 5 FRANCE_TV_STUDIO
==============================================

This script demonstrates the complete flow for using the TEMS API Gateway with the FRANCE_TV_STUDIO API.

Real API endpoint to be tested trough API GATEWAY: https://france-tv-access.adapter.luminvent.com/
...
# Initial banner
print_header("TEMS API Gateway Test - Trial 5 FRANCE_TV_STUDIO")
print("This script will test the TEMS API Gateway with the FRANCE_TV_STUDIO API.\n")
...
# ============================================================================
# STEP 4: Test API call through API Gateway (FRANCE_TV_STUDIO endpoint)
# ============================================================================
print_step(4, "API Test Call through API Gateway - FRANCE_TV_STUDIO ")
print()

original_endpoint = "https://france-tv-access.adapter.luminvent.com/"
...
print_info("The API Gateway will forward the request to the FRANCE_TV_STUDIO API endpoint")
...
print()
print(f"{Colors.CYAN}3. FRANCE_TV_STUDIO API CALL THROUGH GATEWAY{Colors.ENDC}")
print(f"   ✓ Successfully called FRANCE_TV_STUDIO API through TEMS API Gateway")
